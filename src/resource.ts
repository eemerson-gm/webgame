...
export const Resources = {
  ...
  PlayerPunch1: new ex.ImageSource("./assets/player/player_punch1.png"),
  PlayerPunch2: new ex.ImageSource("./assets/player/player_punch2.png"),
  PlayerPunch3: new ex.ImageSource("./assets/player/player_punch3.png"),
  BronzePickaxe: new ex.ImageSource("./assets/tools/bronze_pickaxe.png"),
  BronzePickaxeItem: new ex.ImageSource("./assets/items/bronze_pickaxe.png"),
  ...
  MinerPowerup: new ex.ImageSource("./assets/powerups/miner_powerup.png"),
  MinerPowerupItem: new ex.ImageSource("./assets/items/miner_powerup.png"),
  MinerHat: new ex.ImageSource("./assets/powerups/miner_powerup_hat.png"),
